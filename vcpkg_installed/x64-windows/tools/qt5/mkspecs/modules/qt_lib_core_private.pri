...
QT.core_private.enabled_features = datetimeparser doubleconversion hijricalendar mimetype-database system-pcre2 sha3-fast system-doubleconversion
QT.core_private.disabled_features = clock-gettime etw futimens futimes getauxval getentropy glib glibc gnu-libiconv icu posix-libiconv iconv inotify journald linkat lttng renameat2 slog2 statx syslog
