...
macro(_populate_QmlModels_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5QmlModels_install_prefix}/debug/bin/${LIB_LOCATION}")
    else()
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5QmlModels_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::QmlModels)
    ...
    set(Qt5QmlModels_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlModels_install_prefix}/include/qt5/QtQmlModels/5.15.13"
        "${_qt5QmlModels_install_prefix}/include/qt5/QtQmlModels/5.15.13/QtQmlModels"
    )
    ...
    if (EXISTS
        "${_qt5QmlModels_install_prefix}/debug/bin/Qt5QmlModelsd.dll"
      AND EXISTS
        "${_qt5QmlModels_install_prefix}/debug/lib/Qt5QmlModelsd.lib" )
