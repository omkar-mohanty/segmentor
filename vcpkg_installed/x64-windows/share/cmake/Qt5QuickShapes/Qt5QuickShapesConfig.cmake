...
macro(_populate_QuickShapes_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5QuickShapes_install_prefix}/debug/bin/${LIB_LOCATION}")
    else()
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5QuickShapes_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::QuickShapes)
    ...
    set(Qt5QuickShapes_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickShapes_install_prefix}/include/qt5/QtQuickShapes/5.15.13"
        "${_qt5QuickShapes_install_prefix}/include/qt5/QtQuickShapes/5.15.13/QtQuickShapes"
    )
    ...
    if (EXISTS
        "${_qt5QuickShapes_install_prefix}/debug/bin/Qt5QuickShapesd.dll"
      AND EXISTS
        "${_qt5QuickShapes_install_prefix}/debug/lib/Qt5QuickShapesd.lib" )
