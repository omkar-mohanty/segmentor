...
if (NOT TARGET Qt5::3DQuickRender)
    ...
    set(Qt53DQuickRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickRender_install_prefix}/include/qt5/Qt3DQuickRender/5.15.13"
        "${_qt53DQuickRender_install_prefix}/include/qt5/Qt3DQuickRender/5.15.13/Qt3DQuickRender"
    )
    ...
    _populate_3DQuickRender_target_properties(RELEASE "Qt53DQuickRender.dll" "Qt53DQuickRender.lib" FALSE)
    ...
    if (EXISTS
      ...
      AND EXISTS
        ...
        _populate_3DQuickRender_target_properties(DEBUG "Qt53DQuickRenderd.dll" "Qt53DQuickRenderd.lib" FALSE)
    endif()
