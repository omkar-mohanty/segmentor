...
if (NOT TARGET Qt5::Gamepad)
    ...
    set(_Qt5Gamepad_OWN_INCLUDE_DIRS "${_qt5Gamepad_install_prefix}/include/qt5/" "${_qt5Gamepad_install_prefix}/include/qt5/QtGamepad")
    set(Qt5Gamepad_PRIVATE_INCLUDE_DIRS
        "${_qt5Gamepad_install_prefix}/include/qt5/QtGamepad/5.15.13"
        "${_qt5Gamepad_install_prefix}/include/qt5/QtGamepad/5.15.13/QtGamepad"
    )
    ...
    _populate_Gamepad_target_properties(RELEASE "Qt5Gamepad.dll" "Qt5Gamepad.lib" FALSE)

    if (EXISTS
        "${_qt5Gamepad_install_prefix}/debug/bin/Qt5Gamepadd.dll"
      AND EXISTS
        "${_qt5Gamepad_install_prefix}/debug/lib/Qt5Gamepadd.lib" )
        _populate_Gamepad_target_properties(DEBUG "Qt5Gamepadd.dll" "Qt5Gamepadd.lib" FALSE)
    endif()
