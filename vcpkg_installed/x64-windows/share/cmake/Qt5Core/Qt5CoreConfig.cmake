...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/qt5/QtCore/5.15.13"
        "${_qt5Core_install_prefix}/include/qt5/QtCore/5.15.13/QtCore"
    )
    ...
    set_property(TARGET Qt5::Core
                 ...
                 datetimeparser;doubleconversion;hijricalendar;mimetype-database;system-pcre2;sha3-fast;system-doubleconversion)
    set_property(TARGET Qt5::Core
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 clock-gettime;etw;futimens;futimes;getauxval;getentropy;glib;glibc;gnu-libiconv;icu;posix-libiconv;iconv;inotify;journald;linkat;lttng;renameat2;slog2;statx;syslog)
