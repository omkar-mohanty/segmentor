...
macro(_populate_QuickParticles_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5QuickParticles_install_prefix}/debug/bin/${LIB_LOCATION}")
    else()
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5QuickParticles_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::QuickParticles)
    ...
    set(Qt5QuickParticles_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickParticles_install_prefix}/include/qt5/QtQuickParticles/5.15.13"
        "${_qt5QuickParticles_install_prefix}/include/qt5/QtQuickParticles/5.15.13/QtQuickParticles"
    )
    ...
    if (EXISTS
        "${_qt5QuickParticles_install_prefix}/debug/bin/Qt5QuickParticlesd.dll"
      AND EXISTS
        "${_qt5QuickParticles_install_prefix}/debug/lib/Qt5QuickParticlesd.lib" )
