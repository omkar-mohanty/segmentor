...
macro(_populate_QmlDevTools_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5QmlDevTools_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::QmlDevTools)
    ...
    set(Qt5QmlDevTools_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlDevTools_install_prefix}/include/qt5/QtQml/5.15.13"
        "${_qt5QmlDevTools_install_prefix}/include/qt5/QtQml/5.15.13/QtQml"
    )
    ...
    if(EXISTS "${_qt5QmlDevTools_install_prefix}/debug/lib/Qt5QmlDevToolsd.prl")
        _qt5_QmlDevTools_process_prl_file(
            "${_qt5QmlDevTools_install_prefix}/debug/lib/Qt5QmlDevToolsd.prl" DEBUG
            _Qt5QmlDevTools_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5QmlDevTools_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5QmlDevTools_install_prefix}/lib/Qt5QmlDevTools.prl")
        _qt5_QmlDevTools_process_prl_file(
    ...
    if (EXISTS "${_qt5QmlDevTools_install_prefix}/debug/lib/Qt5QmlDevToolsd.lib" )
