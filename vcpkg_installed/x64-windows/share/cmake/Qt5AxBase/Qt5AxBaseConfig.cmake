...
set(Qt5AxBase_VERSION_STRING 5.15.13)
...
function(_qt5_AxBase_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(_qt5_install_libs "${_qt5AxBase_install_prefix}/debug/lib/")
    else()
...
macro(_populate_AxBase_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if(_static_deps)
        ...
        #message(STATUS "Target Qt5::AxBase static links: ${_static_dep} through ${_static_dep_genex}") # Added for debugging
    endif()
    ...
    if(_static_link_flags)
        ...
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            ...
            #message(STATUS "Target Qt5::AxBase static link flags: ${_static_link_flags} through ${_static_link_flags_genex}")
        endif()
    endif()
...
if (NOT TARGET Qt5::AxBase)
    ...
    set(_Qt5AxBase_OWN_INCLUDE_DIRS "${_qt5AxBase_install_prefix}/include/qt5/" "${_qt5AxBase_install_prefix}/include/qt5/ActiveQt")
    set(Qt5AxBase_PRIVATE_INCLUDE_DIRS
        "${_qt5AxBase_install_prefix}/include/qt5/ActiveQt/5.15.13"
        "${_qt5AxBase_install_prefix}/include/qt5/ActiveQt/5.15.13/ActiveQt"
    )
    ...
    foreach(_module_dep ${_Qt5AxBase_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5AxBase_FIND_VERSION_EXACT}
    ...
    if(EXISTS "${_qt5AxBase_install_prefix}/debug/lib/Qt5AxBased.prl")
        _qt5_AxBase_process_prl_file(
            "${_qt5AxBase_install_prefix}/debug/lib/Qt5AxBased.prl" DEBUG
            _Qt5AxBase_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5AxBase_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5AxBase_install_prefix}/lib/Qt5AxBase.prl")
        _qt5_AxBase_process_prl_file(
