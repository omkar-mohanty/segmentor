...
if (NOT TARGET Qt5::3DRender)
    ...
    set(Qt53DRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DRender_install_prefix}/include/qt5/Qt3DRender/5.15.13"
        "${_qt53DRender_install_prefix}/include/qt5/Qt3DRender/5.15.13/Qt3DRender"
    )
    ...
    _populate_3DRender_target_properties(RELEASE "Qt53DRender.dll" "Qt53DRender.lib" FALSE)

    if (EXISTS
        "${_qt53DRender_install_prefix}/debug/bin/Qt53DRenderd.dll"
      AND EXISTS
        "${_qt53DRender_install_prefix}/debug/lib/Qt53DRenderd.lib" )
        _populate_3DRender_target_properties(DEBUG "Qt53DRenderd.dll" "Qt53DRenderd.lib" FALSE)
    endif()
