...
if(EXISTS "${_qt53DRender_install_prefix}/plugins/sceneparsers/assimpsceneimport.dll")
    _populate_3DRender_plugin_properties(AssimpSceneImportPlugin RELEASE "sceneparsers/assimpsceneimport.dll" FALSE)
endif()
if(EXISTS "${_qt53DRender_install_prefix}/debug/plugins/sceneparsers/assimpsceneimportd.dll")
    _populate_3DRender_plugin_properties(AssimpSceneImportPlugin DEBUG "sceneparsers/assimpsceneimportd.dll" FALSE)
endif()
