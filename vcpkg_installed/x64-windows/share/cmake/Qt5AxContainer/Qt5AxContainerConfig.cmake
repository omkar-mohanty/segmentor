...
set(Qt5AxContainer_VERSION_STRING 5.15.13)
...
function(_qt5_AxContainer_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(_qt5_install_libs "${_qt5AxContainer_install_prefix}/debug/lib/")
    else()
...
macro(_populate_AxContainer_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if(_static_deps)
        ...
        #message(STATUS "Target Qt5::AxContainer static links: ${_static_dep} through ${_static_dep_genex}") # Added for debugging
    endif()
    ...
    if(_static_link_flags)
        ...
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            ...
            #message(STATUS "Target Qt5::AxContainer static link flags: ${_static_link_flags} through ${_static_link_flags_genex}")
        endif()
    endif()
...
if (NOT TARGET Qt5::AxContainer)
    ...
    foreach(_module_dep ${_Qt5AxContainer_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.13 ${_Qt5AxContainer_FIND_VERSION_EXACT}
    ...
    if(EXISTS "${_qt5AxContainer_install_prefix}/debug/lib/Qt5AxContainerd.prl")
        _qt5_AxContainer_process_prl_file(
            "${_qt5AxContainer_install_prefix}/debug/lib/Qt5AxContainerd.prl" DEBUG
            _Qt5AxContainer_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5AxContainer_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5AxContainer_install_prefix}/lib/Qt5AxContainer.prl")
        _qt5_AxContainer_process_prl_file(
