...
macro(_populate_QmlWorkerScript_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5QmlWorkerScript_install_prefix}/debug/bin/${LIB_LOCATION}")
    else()
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5QmlWorkerScript_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::QmlWorkerScript)
    ...
    set(Qt5QmlWorkerScript_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlWorkerScript_install_prefix}/include/qt5/QtQmlWorkerScript/5.15.13"
        "${_qt5QmlWorkerScript_install_prefix}/include/qt5/QtQmlWorkerScript/5.15.13/QtQmlWorkerScript"
    )
    ...
    if (EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/debug/bin/Qt5QmlWorkerScriptd.dll"
      AND EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/debug/lib/Qt5QmlWorkerScriptd.lib" )
