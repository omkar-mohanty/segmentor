...
macro(_populate_DesignerComponents_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5DesignerComponents_install_prefix}/debug/bin/${LIB_LOCATION}")
    else()
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5DesignerComponents_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::DesignerComponents)
    ...
    set(Qt5DesignerComponents_PRIVATE_INCLUDE_DIRS
        "${_qt5DesignerComponents_install_prefix}/include/qt5/QtDesignerComponents/5.15.13"
        "${_qt5DesignerComponents_install_prefix}/include/qt5/QtDesignerComponents/5.15.13/QtDesignerComponents"
    )
    ...
    if (EXISTS
        "${_qt5DesignerComponents_install_prefix}/debug/bin/Qt5DesignerComponentsd.dll"
      AND EXISTS
        "${_qt5DesignerComponents_install_prefix}/debug/lib/Qt5DesignerComponentsd.lib" )
