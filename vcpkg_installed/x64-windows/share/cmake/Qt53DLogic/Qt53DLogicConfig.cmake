...
if (NOT TARGET Qt5::3DLogic)
    ...
    set(Qt53DLogic_PRIVATE_INCLUDE_DIRS
        "${_qt53DLogic_install_prefix}/include/qt5/Qt3DLogic/5.15.13"
        "${_qt53DLogic_install_prefix}/include/qt5/Qt3DLogic/5.15.13/Qt3DLogic"
    )
    ...
    _populate_3DLogic_target_properties(RELEASE "Qt53DLogic.dll" "Qt53DLogic.lib" FALSE)

    if (EXISTS
        "${_qt53DLogic_install_prefix}/debug/bin/Qt53DLogicd.dll"
      AND EXISTS
        "${_qt53DLogic_install_prefix}/debug/lib/Qt53DLogicd.lib" )
        _populate_3DLogic_target_properties(DEBUG "Qt53DLogicd.dll" "Qt53DLogicd.lib" FALSE)
    endif()
